...
const DashBoardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="bg-white dark:bg-dark dark:text-white rounded-full shadow-[10px_10px_20px_rgba(218,_213,_213,_0.15)] p-2 w-full flex items-center ">
        <div className="flex-1 px-5">
          <input
            type="text"
            placeholder="Do fundrise now"
            className="w-full text-sm bg-transparent placeholder:text-text4 text-text1 outline-none dark:text-white"
          />
        </div>
